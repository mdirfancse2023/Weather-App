...
public class MainActivity extends AppCompatActivity {
        ...
        searchIV.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (cityEdt.getText().toString().isEmpty()){
                    ...
                    String city = cityEdt.getText().toString().substring(0,1).toUpperCase(Locale.ROOT)+cityEdt.getText().toString().substring(1).toLowerCase(Locale.ROOT);
    ...
    private void getWeatherInfo(String cityName){
        String url = "http://api.weatherapi.com/v1/forecast.json?key=e2f878f08ce9459aaea131708222812&q=" + cityName + "&days=1&aqi=yes&alerts=yes";
        cityNameTV.setText(cityName);
